...
export default function AdminDashboard() {
      ...
      <div className="relative z-10 flex items-center gap-6">
        ...
        <div className="flex items-center gap-4 flex-shrink-0">
          ...
          <div className="flex gap-2">
            <button
              onClick={() => {
                console.log('🔍 [ADMIN] Ouverture des détails pour candidat:', candidate.id, candidate.name);
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex gap-2">
            <button
              onClick={() => {
                console.log('🔍 [ADMIN] Ouverture des détails pour candidat (vue carte):', candidate.id, candidate.name);
                setSelectedCandidate(candidate);
              }}
  ...
  const CandidateDetailModal = ({ candidate, onClose }) => {
    console.log('🎯 [ADMIN] Rendu de la modal pour candidat:', candidate?.id, candidate?.name);
        ...
        {activeTab === 'candidates' && (
          <>
            ...
            <AnimatePresence>
              {selectedCandidate && (
                <>
                  {console.log('🎯 [ADMIN] Affichage de la modal pour:', selectedCandidate.id, selectedCandidate.name)}
                  <CandidateDetailModal
                    candidate={selectedCandidate}
                    onClose={() => {
                      console.log('🔒 [ADMIN] Fermeture de la modal');
                      setSelectedCandidate(null);
                    }}
                  />
                </>
