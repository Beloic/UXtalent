  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage(`❌ Erreur lors de la mise à jour: ${errorData.error || 'Erreur inconnue'}`);
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Modifiez les informations essentielles de votre offre</p>
            </div>
  ...
  return (
    ...
    >
      ...
      <div className="p-8 border-b border-gray-200">
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Modifier l'offre d'emploi</h2>
          <p className="text-gray-600">Modifiez les informations de votre offre "{job.title}"</p>
        </div>
