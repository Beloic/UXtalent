-- Script final pour supprimer la table 'visible'
-- À copier-coller dans l'interface SQL de Supabase

-- Supprimer la vue candidates_visibility
DROP VIEW IF EXISTS candidates_visibility CASCADE;

-- Supprimer les fonctions liées à la visibilité
...
-- Supprimer la table visible et toutes ses contraintes
